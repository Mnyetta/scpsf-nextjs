...
const sections = [
  ...
  { id: "about", label: "About Us", description: "Our mission and work" },
  { id: "programs", label: "Programs", description: "Get help & volunteer programs" },
  { id: "impact", label: "Impact", description: "How we are making a difference" },
